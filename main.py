...
path = "myData" # folder with all the class folder
...
#  X: list of images, 3 - RGB images
#Y : list of labels, where each label is a numeric value corresponding to the class of the traffic sign.
